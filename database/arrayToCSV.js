...
// other_sellers = arrayToCSV(other_sellers);
// products = arrayToCSV(products);
// forms = arrayToCSV(forms);
// products_other_sellers_table_data = arrayToCSV(products_other_sellers_table_data);

// console.log(other_sellers);
